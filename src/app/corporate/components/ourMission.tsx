        ...
        <div className="flex flex-col gap-8 sm:gap-16">
          ...
          <div className="flex flex-col md:flex-row gap-6 sm:gap-8 items-start">
            <div className="w-full md:w-1/2 order-2 md:order-1 text-black flex flex-col justify-center">
              <h1 className="text-3xl sm:text-5xl font-normal mb-3 sm:mb-4 font-britti text-black">{t("corporate.mission")} </h1>
            ...
            <div className="w-full md:w-1/2 order-1 md:order-2 relative h-[300px] sm:h-[400px]">
              <Image
                src="/corporate/our-mission.JPG"
